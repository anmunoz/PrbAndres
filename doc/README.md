...
The **Quick Start Guide** is found at readthedocs.org provides a good documentation summary ([Cygnus](quick_start_guide.md)).
...
The **Processors Catalogue** completes the available documentation for Cygnus ([Cygnus](processors_catalogue/README.md)).
...
Any doubt you may have, please refer to the [Cygnus Core Team](installation_and_administration_guide/issues_and_contact.md).
